...
def xnglo_pipeline(word):
    ...
    word = word.replace('thought', 'Jot')     # 'J' represents 'th' sound
    word = word.replace('through', 'Jru')     # 'J' represents 'th' sound
    word = word.replace('though', 'Jf')       # 'J' represents 'th' sound
    word = word.replace('bough', 'baa')       # Phonetic adjustment
...
# Comprehensive list of test and core words
words_to_process = [
...
print(f"'{csv_filename}' successfully updated with all pipeline rules!")